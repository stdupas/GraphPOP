...
#' @docType methods
#' @rdname show-methods
#' @aliases show,coalescent

setMethod("show", "coalescent", function(object){
...
#' Converts coalescent objects into Newick trees.
#' @description
#' This method converts coalescent objects from a coalescence simulation into a Newick-formatted tree.
#' @param coalescent Coalescent object. This object is generated by a coalescent simulation (implemented in the `simulCoal` method).
...
#' coalescent_2_newick method for coalescent objects.
#' 
#' @name coalescent_2_newick
#' @docType methods
#' @rdname coalescent_2_newick-methods
#' @aliases coalescent_2_newick,coalescent
